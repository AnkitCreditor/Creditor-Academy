...
{/* What You'll Learn - Center Aligned Implementation */}
<motion.div 
  initial={{ opacity: 0 }}
  ...
  {[
    {
      ...
      desc: "Status correction and the principles of sovereignty",
      Icon: FaBalanceScale,
    ...
    },
    {
      ...
      desc: "Understanding legal fictions and how to rebut presumption",
      Icon: FaGavel,
    ...
    },
    {
      ...
      desc: "How to remove yourself from public jurisdiction",
      Icon: FaUserLock,
    ...
    },
    {
      ...
      desc: "The first legal documents and private contracts you&#39;ll need",
      Icon: FaFileContract,
    ...
    },
    {
      ...
      desc: "How to begin protecting yourself and your estate",
      Icon: FaShieldAlt,
    ...
    >
      ...
      <div style={{ 
        ...
        <div style={{
          ...
          right: 0,
          bottom: 0,
          background: `linear-gradient(to bottom, rgba(0,0,0,0.1) 0%, ${item.color}40 100%)`
        }}></div>
      </div>
...
<GameBanner />
      ...
      {/* Enhanced "What You Can Do" Section */}
<motion.div
  variants={fadeInUp}
  initial="hidden"
  whileInView="visible"
