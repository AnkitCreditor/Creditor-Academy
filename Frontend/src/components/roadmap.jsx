      ...
      >
        <motion.div
          style={{
            ...
            width: '100%',
            height: '100%',
            background: 'linear-gradient(to right, rgba(255,255,255,0.85), rgba(236,245,255,0.8), rgba(255,255,255,0.85))',
            zIndex: 1
          }}
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <div style={{
          ...
          >
            ...
            >
              The <motion.span style={{ color: '#0e6297ff', display: 'inline-block' }}
                whileHover={{
                  scale: 1.05,
                  rotate: [0, -2, 2, -2, 0],
