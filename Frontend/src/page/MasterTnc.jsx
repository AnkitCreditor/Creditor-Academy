  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: '1.1rem', lineHeight: 1.6, marginBottom: '30px', textAlign: 'center' }}>
        By joining CREDITOR ACADEMY, a Private Montessori Association and/or any website or Social Media
      ...
      <iframe
        ...
        id="inline-ocYS1yVCfWxOe011l8ew"
        data-layout="{'id':'INLINE'}"
        data-trigger-type="alwaysShow"
        data-activation-type="alwaysActivated"
        data-deactivation-type="neverDeactivate"
        title="master Class T&C"
      />
      <script src="https://api.wonderengine.ai/js/form_embed.js" type="text/javascript"></script>

      {/* Section 1 */}
      <h3 style={sectionHeading}>1. Purpose and Legal Standing</h3>
      <p style={paragraph}>
        ...
        law, health, and other areas—all outside the jurisdiction of governmental and regulatory authorities.
      </p>
      ...
      {/* Section 2 */}
      <h3 style={sectionHeading}>2. Private Domain & Freedom of Association</h3>
      ...
      {/* Section 3 */}
      <h3 style={sectionHeading}>3. Membership Rights and Responsibilities</h3>
      ...
      <ol style={{ ...listStyle, listStyleType: 'upper-roman' }}>
        <li>Education</li>
      ...
      {/* Section 4 */}
      <h3 style={sectionHeading}>4. Masterclass Membership & Monthly Fee</h3>
      <ul style={listStyle}>
      ...
      {/* Section 5 */}
      <h3 style={sectionHeading}>5. Cancellation Policy</h3>
      ...
      {/* Section 6 */}
      <h3 style={sectionHeading}>6. Membership Eligibility and Termination</h3>
      <ul style={listStyle}>
      ...
      {/* Section 7 */}
      <h3 style={sectionHeading}>7. Dispute Resolution & Limitation of Liability</h3>
      ...
      {/* Section 8 */}
      <h3 style={sectionHeading}>8. Voluntary Participation & Legal Standing</h3>
      <ul style={listStyle}>
      ...
      {/* Section 9 */}
      <h3 style={sectionHeading}>9. Agreement & Acknowledgment</h3>
      <ul style={{ ...listStyle, listStyleType: 'none', paddingLeft: 0 }}>
        <li><input type="checkbox" style={{ marginRight: '10px' }} defaultChecked /> I have read and understood this document in its entirety.</li>
        <li><input type="checkbox" style={{ marginRight: '10px' }} defaultChecked /> I am joining of my own free will, without coercion or pressure.</li>
        <li><input type="checkbox" style={{ marginRight: '10px' }} defaultChecked /> I acknowledge that this is a private association and agree to abide by its rules.</li>
        <li><input type="checkbox" style={{ marginRight: '10px' }} defaultChecked /> I understand that my failure to comply with membership terms may result in termination of membership.</li>
      </ul>
    </section>
  );
};
...
export default MasterclassMembershipTC;